...
import {resourceInputSchemaGen, resourceOutputSchemaGen} from "../../_generated/index.js";
import {recordId} from "../../_generated/recordSchema.js";

// payload schema for creating a new resource entity
export const resourceCreateSchema = resourceInputSchemaGen.merge(z.object({
...
export const resourceSchema = resourceOutputSchemaGen.merge(z.object({
