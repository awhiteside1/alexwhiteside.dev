...
import {
	repositoryInputSchemaGen,
	repositoryOutputSchemaGen,
...
export const repositoryCreateSchema = repositoryInputSchemaGen.merge(
	z.object({
...
export const repositorySchema = repositoryOutputSchemaGen.merge(
	z.object({
