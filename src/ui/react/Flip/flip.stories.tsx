...
export const phrasesExample: StoryObj<typeof FlipWords> = {
    args: {
        words: ["brush my teeth.", "only rolled my own auth once.", "faced fstab and won.", "thinks in systems.", "lives in Philadelphia.", "preaches volatility-based decomposition."],
    }
}


export const ChatGPT: StoryObj<typeof FlipWords> = {
    render: () => <p><span>I never thought I'd be </span><FlipWords
        words={[
