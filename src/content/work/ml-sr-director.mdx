...
-   Leveraged React Server Components to achieve \<1s FCP and \<2s LCP (p75) on dynamic load
-   Decided on using Reshaped as primary design system base, convincing designers and developers
